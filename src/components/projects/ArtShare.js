...
const tileData = [
  {
    image: '/img/artshare.png',
    title: 'React Client',
    author: 'Jesse Lewis',
  },
  {
    image: '/img/artshare-api.png',
    title: 'Node/Express API',
    author: 'Jesse Lewis',
  },
  {
    image: '/img/artshare-diagram.png',
    title: 'ArtShare Architecture',
    author: 'Jesse Lewis'
  }
]

class ArtShare extends React.Component {
  constructor(props){
    super(props);
    this.state={
      open: false,
...
export default withStyles(styles)(ArtShare);